...
export const SERENE_PERSONA_PART1 = {
  ...
  meta: {
    name: "Serene AI Counselor - Psychological Framework Integrated",
    version: "2.0.0",
    lastUpdated: "2026-02-05",
    framework: "Rogerian + CBT + MI + Attachment Theory + Trauma-Informed",
    description: "心理学的推論エンジンを搭載した共感的AIカウンセラー"
  },
